...
export const salviaUnits: SalviaUnit[] = [
  {
    ...
    subtitle: { es: 'Departamento en la esquina', en: 'Corner unit' },
    ...
    views: { es: 'Laguna y Mar', en: 'Lagoon & Sea' },
