...
export const destinations: DestinationConfig[] = [
  // ─── PRIORITY 1: CANCÚN ───
  {
    ...
    stats: [
      ...
      { val: 'Mondrian Residences at Grand Island Cancun', label: { es: 'Desarrollo Destacado', en: 'Featured Development' } },
    ],
    chips: {
    ...
    subPages: [
      {
        ...
        intro: {
          es: [
            ...
            'Desde estudios de una recámara ideales para Airbnb hasta unidades de tres recámaras para familias, la Zona Hotelera tiene condos para todo perfil de inversión. Los desarrollos como Mondrian Residences at Grand Island Cancun y Bay View Grand elevan el estándar con amenidades de marca internacional.',
          ],
          en: [
            ...
            'From one-bedroom studios ideal for Airbnb to three-bedroom family units, the Hotel Zone has condos for every investment profile. Developments like Mondrian Residences at Grand Island Cancun and Bay View Grand raise the bar with internationally branded amenities.',
          ],
        },
      },
      {
      ...
      },
      {
        ...
        intro: {
          es: [
            'La preventa en la Zona Hotelera de Cancún ofrece la oportunidad de adquirir propiedades frente al mar a precios significativamente menores al valor de entrega. Los desarrollos en preventa como Mondrian Residences at Grand Island Cancun proyectan una plusvalía del 33% entre la compra y la entrega.',
          ...
          en: [
            'Pre-sale in Cancun\'s Hotel Zone offers the opportunity to acquire beachfront properties at prices significantly below delivery value. Pre-sale developments like Mondrian Residences at Grand Island Cancun project 33% appreciation between purchase and delivery.',
