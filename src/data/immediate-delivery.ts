...
export const immediateDeliveryUnits: ImmediateUnit[] = [
  {
    ...
    subtitle: { es: 'Departamento 205M', en: 'Residence 205M' },
    area: 105,
    bedrooms: 1,
    bathrooms: 1.5,
    parking: 2,
  ...
  },
  {
    ...
    development: { es: 'La Amada Residences', en: 'La Amada Residences' },
    location: { es: 'Costa Mujeres, Cancún', en: 'Costa Mujeres, Cancún' },
    subtitle: { es: 'Penthouse 07M', en: 'Penthouse 07M' },
    area: 202,
    interior: 172,
    bedrooms: 1,
    bathrooms: 1,
  ...
  {
    id: 'la-amada-a4203',
    slug: 'la-amada-unit-a4-203',
    code: 'A4-203',
    development: { es: 'La Amada Residences', en: 'La Amada Residences' },
    location: { es: 'Costa Mujeres, Cancún', en: 'Costa Mujeres, Cancún' },
    subtitle: { es: 'Departamento A4-203', en: 'Residence A4-203' },
    area: 301,
    interior: 248,
    bedrooms: 3,
    bathrooms: 3.5,
    ...
    status: { es: 'Amueblada — lista para habitar', en: 'Furnished — move-in ready' },
    features: {
      es: ['3 recámaras + cuarto de servicio', 'Terraza 53 m² con vista al mar', 'Totalmente amueblada'],
      en: ['3 bedrooms + service room', '53 m² ocean-view terrace', 'Fully furnished'],
    },
    image: LA_AMADA_BEACHFRONT,
    whatsappMsg: {
      es: 'Hola Rivana, me interesa la unidad A4-203 (Entrega Inmediata) en La Amada, Costa Mujeres.',
      en: "Hi Rivana, I'm interested in Unit A4-203 (Immediate Delivery) at La Amada, Costa Mujeres.",
    },
  },
  {
    id: 'la-amada-305l',
    ...
    development: { es: 'La Amada Residences', en: 'La Amada Residences' },
    location: { es: 'Costa Mujeres, Cancún', en: 'Costa Mujeres, Cancún' },
    subtitle: { es: 'Departamento 305L', en: 'Residence 305L' },
    area: 169,
    interior: 123,
    bedrooms: 1,
    bathrooms: 1,
