...
export const immediateDeliveryUnits: ImmediateUnit[] = [
  ...
  },
  {
    ...
    priceMXN: 12000000,
    priceNote: { es: 'Antes $13.2M MXN', en: 'Was $13.2M MXN' },
    furnished: true,
    moveInReady: true,
    status: { es: 'Amueblada — reducción de $1.2M', en: 'Furnished — $1.2M reduction' },
    features: {
      es: ['Configuración lock-off', 'Terraza privada 40 m²', 'Doble fuente de renta'],
      en: ['Lock-off layout', '40 m² private terrace', 'Dual rental income'],
    },
