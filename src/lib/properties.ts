...
import thompsonTorres from '@/assets/thompson-torres.webp';
import thompsonAerea from '@/assets/thompson-aerea.webp';
import thompsonSkyBeach from '@/assets/thompson-sky-beach.webp';
import thompsonAlbercaAdults from '@/assets/thompson-alberca-adults.webp';
import thompsonLiving from '@/assets/thompson-living.webp';
import thompsonSalaCocina from '@/assets/thompson-sala-cocina.webp';
import thompsonPenthouse from '@/assets/thompson-penthouse.webp';
import thompsonTerraza from '@/assets/thompson-terraza.webp';
import thompsonBano from '@/assets/thompson-bano.webp';
import thompsonGimnasio from '@/assets/thompson-gimnasio.webp';
import thompsonVistaMar from '@/assets/thompson-vista-mar.webp';
    ...
    differentiators: [
      {
        ...
        description: 'Cada unidad se entrega totalmente amueblada, equipada y lista para operar bajo la gestión de Marca Elite internacional. Sin curva de aprendizaje. Sin gestión directa. Solo rendimientos.',
        descriptionEn: 'Every unit is delivered fully furnished, equipped, and ready to operate under Marca Elite internacional\'s management. No learning curve. No hands-on management. Just returns.',
        stat: '33%', statLabel: 'plusvalía', statLabelEn: 'appreciation',
        pills: ['Listo para operar', 'Gestión Marca Elite internacional'],
        pillsEn: ['Ready to operate', 'Marca Elite internacional Management'],
      },
      {
        type: 'exclusivo', layout: 'grid',
      ...
      {
        type: 'amenidad', layout: 'grid',
        title: 'Operado por Marca Elite internacional',
        titleEn: 'Operated by Marca Elite internacional',
        description: 'Marca Elite internacional es uno de los grupos hoteleros más grandes del mundo. La marca atrae a un viajero de alto poder adquisitivo — lo que se traduce directamente en ocupación premium y tarifas superiores.',
        descriptionEn: 'Marca Elite internacional is one of the largest hotel groups in the world. The brand attracts high-net-worth travelers — which translates directly into premium occupancy and higher nightly rates.',
      },
      {
        type: 'vista', layout: 'grid',
...
images: [dhamarPrincipal, dhamarAlberca, dhamarRooftop, dhamarYogaPilates, dhamarBeachclub1, dhamarBeachclub2],
  ...
  },
  {
    ...
    seoDescription: 'Residencias de lujo SLS Hotels en Puerto Cancún. Arquitectonica + Marca Elite internacional. Unidades 191–356 m² desde $1.6M USD. Entrega verano 2028.',
    seoDescriptionEn: 'SLS Hotels luxury residences in Puerto Cancún. Arquitectonica design + Marca Elite internacional management. Units 191–356 m² from $1.6M USD. Summer 2028 delivery.',
  ...
  // ─── BAY VIEW GRAND AT GRAND ISLAND ───
  {
    ...
    description: 'Un desarrollo exclusivo en la Zona Hotelera de Cancún que redefine el lujo. Condominios con terraza, brisa del mar y amenidades de resort completo. Interiores seleccionados por Filipão Nunes, arquitecto portugués de reconocida presencia internacional cuyo diseño convierte a BVG en un santuario para experiencias sensoriales. 5 tipologías para diferentes perfiles: desde inversionista hasta usuario final de alto patrimonio.',
  ...
  // ─── THOMPSON RESIDENCES PUERTO CANCÚN ───
  {
    ...
    seoTitle: 'Thompson Private Residences Puerto Cancún | Departamentos de Lujo Frente al Mar Caribe',
    seoTitleEn: 'Thompson Private Residences Puerto Cancún | Luxury Oceanfront Living in the Mexican Caribbean',
    seoDescription: 'Thompson Private Residences Puerto Cancún — residencias de lujo by invitation con elevador privado, terrazas al Mar Caribe y servicios de resort 24/7.',
    seoDescriptionEn: 'Thompson Private Residences Puerto Cancún — invitation-only luxury homes with private elevator, Caribbean terraces, and 24/7 resort-grade services.',
    zone: 'Puerto Cancún, Cancún',
    zoneEn: 'Puerto Cancún, Cancún',
    status: 'preventa' as const,
    priceFromUSD: 730000,
    ...
    roiEstimate: 0,
    plusvaliaEstimate: 0,
    images: [thompsonSkyBeach, thompsonVistaMar, thompsonTorres, thompsonAerea, thompsonAlbercaAdults, thompsonLiving, thompsonSalaCocina, thompsonPenthouse, thompsonTerraza, thompsonBano, thompsonGimnasio],
    description: 'Las primeras Thompson Private Residences del mundo eligen Puerto Cancún como su hogar — y no es casualidad. Aquí, donde la marina de clase mundial se funde con el Mar Caribe y un campo de golf de 18 hoyos diseñado por Tom Weiskopf, nace un estilo de vida que trasciende el lujo convencional.\n\nUna comunidad selecta, accesible únicamente por invitación, donde cada residente comparte una visión de elegancia, individualidad y sofisticación. No es solo una residencia: es una declaración de pertenencia.\n\nResidencias diseñadas para vivir extraordinariamente. Cada unidad cuenta con acceso privado y directo en elevador, amplias terrazas con vistas panorámicas al Mar Caribe, encimeras de mármol, electrodomésticos de lujo, refrigerador de vinos integrado y acabados premium en cada rincón. Los penthouses de 5 habitaciones ofrecen opciones de diseño flexible para adaptarse a la visión de cada propietario.\n\nAmenidades que elevan cada día. En la azotea, una playa privada en el cielo y alberca solo para adultos redefinen el descanso. El gimnasio equipado, el spa, el simulador de golf, el cine privado, el bar junto al canal y los salones para eventos crean un ecosistema donde la vitalidad y la convivencia son parte de la rutina.\n\nServicios de concierge de nivel hotelero. Un equipo dedicado 24 horas atiende cada necesidad: valet parking, choferes, alquiler de yates, chef personal, sommelier, personal shopper, limpieza diaria, paseador de mascotas, organización de eventos y más de 30 servicios adicionales a la carta. La vida aquí se administra sola.\n\nUbicación privilegiada en Puerto Cancún. A pasos de Marina Town Center, restaurantes gourmet y clubes de playa privados, con acceso a una de las comunidades privadas más exclusivas del Caribe Mexicano. Disponible en configuraciones de 2, 3 y 4 recámaras, y penthouses de 5 recámaras.\n\nTu inversión, tu legado.',
    descriptionEn: 'The world\'s first Thompson Private Residences find their home in Puerto Cancún — a setting where a world-class marina, an 18-hole Tom Weiskopf-designed golf course, and the turquoise waters of the Caribbean Sea converge to create something the world has never seen before.\n\nThis is an invitation-only community — a curated circle of like-minded individuals who share a vision of elegance, privacy, and refined living. Here, belonging is earned, not purchased.\n\nResidences engineered for the extraordinary. Each home features private elevator access directly to your door, sweeping Caribbean-view terraces, bold marble kitchen countertops, premium integrated appliances, wine refrigerators, and luxury finishes throughout. Penthouse residences offer flexible design configurations tailored to each owner\'s vision.\n\nAmenities that redefine everyday living. A rooftop private beach and adults-only pool float above the Caribbean. Below, a fully equipped gym, spa, golf simulator, private cinema, canal-side bar, and dedicated event lounges create a resort ecosystem where vitality and connection become daily rituals.\n\nHotel-grade concierge at your service, 24/7. Your dedicated concierge team handles everything: valet parking, private drivers, yacht rentals, in-residence chef, wine sommelier, personal shopper, daily housekeeping, pet walking, floral arrangements, event planning, and over 30 additional à la carte services. Life here runs itself.\n\nAn address without equal in Puerto Cancún. Steps from Marina Town Center, gourmet dining, and private beach clubs — inside one of the most exclusive private communities in the Mexican Caribbean. Available in 2-, 3-, and 4-bedroom residences and 5-bedroom penthouses.\n\nYour investment, your legacy.',
    features: [
