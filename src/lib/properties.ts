...
export const properties: PropertyDetail[] = [
  ...
  },
  {
    ...
    description: 'The Residences at Grand Island Cancun es una residencia de marca dentro del desarrollo maestro más exclusivo de la Zona Hotelera de Cancún — diseñada por Filipao Nunes Arquitectos y operada por Marca Elite internacional bajo la marca Mondrian. Cada unidad se entrega llave en mano, totalmente amueblada y equipada, lista para operar desde el primer día. Invertir aquí es adquirir un activo que trabaja por ti, respaldado por una de las marcas hoteleras más reconocidas del mundo. Tu legado frente al Caribe.',
    ...
    differentiators: [
      {
        ...
        description: 'Cada unidad se entrega totalmente amueblada, equipada y lista para operar bajo la gestión de Marca Elite internacional y la marca Mondrian. Sin curva de aprendizaje. Sin gestión directa. Solo rendimientos.',
        descriptionEn: 'Every unit is delivered fully furnished, equipped, and ready to operate under Marca Elite internacional\'s management and the Mondrian brand. No learning curve. No hands-on management. Just returns.',
      ...
      {
        type: 'amenidad', layout: 'grid',
        title: 'Operado por Marca Elite internacional — marca Mondrian',
        titleEn: 'Operated by Marca Elite internacional — Mondrian brand',
        description: 'Marca Elite internacional es uno de los grupos hoteleros más grandes del mundo. La marca Mondrian atrae a un viajero de alto poder adquisitivo — lo que se traduce directamente en ocupación premium y tarifas superiores.',
        descriptionEn: 'Marca Elite internacional is one of the largest hotel groups in the world. The Mondrian brand attracts high-net-worth travelers — which translates directly into premium occupancy and higher nightly rates.',
      },
      {
        type: 'vista', layout: 'grid',
