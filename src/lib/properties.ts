...
images: [dhamarPrincipal, dhamarAlberca, dhamarRooftop, dhamarYogaPilates, dhamarBeachclub1, dhamarBeachclub2],
  ...
  // ─── THOMPSON RESIDENCES PUERTO CANCÚN ───
  {
    ...
    roiEstimate: 0,
    plusvaliaEstimate: 0,
    images: [thompsonTorres, thompsonAerea, thompsonSkyBeach, thompsonAlbercaAdults, thompsonLiving, thompsonSalaCocina, thompsonPenthouse, thompsonTerraza, thompsonBano, thompsonGimnasio],
