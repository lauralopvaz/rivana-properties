        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="transition-opacity duration-300" style={{ opacity: fadeOut ? 0 : 1 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', marginTop: '2px' }}>
              ...
              <a
                href="https://wa.me/529988457224?text=Quiero%20agendar%20una%20cita&utm_source=web529988457224?text=Quiero%20agendar%20una%20citautm_medium=whatsapp529988457224?text=Quiero%20agendar%20una%20citautm_campaign=lead&utm_content=scheduling-modal"
                target="_blank"
