      ...
      <div className="max-w-[1100px] mx-auto px-6 lg:px-10">
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <p className="font-body font-light text-muted-foreground max-w-2xl mx-auto" style={{ fontSize: '17px' }}>
        ...
        <ScrollReveal>
          <div className="max-w-3xl mx-auto space-y-5 font-body font-light text-secondary/85 mb-14" style={{ fontSize: '16px', lineHeight: 1.8 }}>
            <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {[
              ...
              <div key={label} className="p-6" style={{ border: '1px solid rgba(0,0,0,0.07)', backgroundColor: 'hsl(var(--paper))' }}>
                ...
                <h3 className="font-display text-lg mb-2 text-secondary">{label}</h3>
                <p className="font-body font-light text-muted-foreground text-sm" style={{ lineHeight: 1.7 }}>{text}</p>
              </div>
            ))}
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <div className="max-w-2xl mx-auto p-8 lg:p-10" style={{ backgroundColor: '#FFFFFF', border: '1px solid rgba(0,0,0,0.07)' }}>
            {success ? (
