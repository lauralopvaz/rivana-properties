...
export const PreSaleSection = () => {
  ...
  const stats = L === 'es'
    ? [{ value: '8–12%', label: 'Rendimiento anual' }, { value: '15–33%', label: 'Plusvalía a entrega' }, { value: '4', label: 'Proyectos activos' }]
    : [{ value: '8–12%', label: 'Annual yield' }, { value: '15–33%', label: 'Appreciation at delivery' }, { value: '4', label: 'Active projects' }];
