      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 flex items-center justify-between h-20">
        ...
        <div className="hidden lg:flex items-center gap-8">
          ...
          <Button variant="gold" size="sm" asChild>
            <a href="https://wa.me/529988457224?text=Quiero%20asesor%C3%ADa%20inmobiliaria&utm_source=webhttps://wa.me/529988457224?text=Quiero%20asesor%C3%ADa%20inmobiliariautm_medium=whatsapphttps://wa.me/529988457224?text=Quiero%20asesor%C3%ADa%20inmobiliariautm_campaign=lead&utm_content=navbar" target="_blank" rel="noopener noreferrer" aria-label={language === 'es' ? 'Contactar asesor por WhatsApp' : 'Contact advisor via WhatsApp'}>
              {t('nav.advisor')}
            </a>
          </Button>
        </div>
