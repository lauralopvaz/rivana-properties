...
export const MondrianGrandIslandBodyES = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <h2 className="text-foreground">El respaldo que cambia todo: Marca Elite internacional y Grand Island</h2>
      ...
      <div className="my-10 text-center">
        <Link to={localePath('/propiedad/mondrian-residences-grand-island-cancun')}>
          <Button variant="gold" size="lg">Ver la propiedad Mondrian Residences at Grand Island Cancun →</Button>
        </Link>
      </div>
      ...
      <p>Si quieres conocer disponibilidad de unidades, detalles del contrato o explorar si Mondrian Residences at Grand Island Cancun se alinea con tus objetivos de inversión y estilo de vida, el primer paso es una conversación.</p>

      {/* CTA 3 — full width */}
      <div className="my-12 text-center">
        <a href="https://wa.me/529988457224?text=Quiero%20asesor%C3%ADa%20inmobiliaria%20sobre%20The%20Residences%20at%20Grand%20Island%20Cancun" target="_blank" rel="noopener noreferrer" className="block">
...
export const MondrianGrandIslandBodyEN = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <p>Some developments arrive at exactly the right moment. <strong className="text-foreground">Mondrian Residences at Grand Island Cancun</strong>, is one of them: the full weight of Marca Elite internacional — the world's largest hotel group — behind every square meter, an address that will define a generation of Cancún real estate, unobstructed views of both the Caribbean Sea and Laguna de Nichupté that no future construction will ever block, and a pre-sale price that still makes sense before it no longer does.</p>
      ...
      <p>Mondrian Residences at Grand Island Cancun is for the investor who understands that wealth is not built by waiting for the perfect moment, but by making informed decisions when opportunity is present. It's for the buyer who values the operational weight of the world's largest hotel group behind the asset, the certainty of views that no one will ever obstruct, and the vision to be positioned in a destination that global demand is now recognizing.</p>

      <p>It's also for the investor seeking an asset that works: vacation rental income within a Marca Elite internacional-operated complex makes this unit a yield-generating instrument, not just a passive appreciation play. A guest who chooses Grand Island is not looking for a rental apartment — they are seeking an experience, and they are prepared to pay for it.</p>
      ...
      <p>If you'd like to explore unit availability, review contract details, or understand whether Mondrian Residences at Grand Island Cancun aligns with your investment goals and lifestyle vision, the first step is a conversation.</p>

      {/* CTA 3 — full width */}
      <div className="my-12 text-center">
        <a href="https://wa.me/529988457224?text=I%20Want%20Real%20Estate%20Advisory%20about%20The%20Residences%20at%20Grand%20Island%20Cancun" target="_blank" rel="noopener noreferrer" className="block">
