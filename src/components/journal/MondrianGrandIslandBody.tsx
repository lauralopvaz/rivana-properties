...
export const MondrianGrandIslandBodyES = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <p>Hay desarrollos que simplemente llegan en el momento correcto. <strong className="text-foreground">Mondrian Residences en Grand Island, Cancún</strong>, es uno de ellos: el respaldo de Accor — el grupo hotelero más grande del mundo — una ubicación que en cinco años todos van a reconocer, vistas al mar Caribe y a la Laguna de Nichupté que jamás serán obstruidas, y un precio de preventa que todavía hace posible lo que después será una cifra muy distinta.</p>
      ...
      <div className="my-10 text-center">
        <Link to={localePath('/propiedad/mondrian-residences-grand-island-cancun')}>
          <Button variant="gold" size="lg">Ver la propiedad Mondrian Residences →</Button>
        </Link>
      </div>
      ...
      <p>Una de las dimensiones que más distingue a Mondrian Residences del resto de la oferta de preventa en Cancún es el ecosistema de amenidades al que el residente tiene acceso — no solo las propias del edificio, sino las del complejo Grand Island en su totalidad, operadas bajo los estándares de Accor.</p>
      ...
      <p>Si quieres conocer disponibilidad de unidades, detalles del contrato o explorar si Mondrian Residences se alinea con tus objetivos de inversión y estilo de vida, el primer paso es una conversación.</p>
      ...
      <div className="my-12 text-center">
        <a href="https://wa.me/529988457224?text=Quiero%20asesor%C3%ADa%20inmobiliaria%20sobre%20Mondrian%20Residences" target="_blank" rel="noopener noreferrer" className="block">
          <Button variant="gold" size="lg" className="w-full max-w-lg mx-auto">Quiero asesoría inmobiliaria sobre Mondrian Residences</Button>
        </a>
      </div>
...
export const MondrianGrandIslandBodyEN = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <p>Some developments arrive at exactly the right moment. <strong className="text-foreground">Mondrian Residences at Grand Island, Cancún</strong>, is one of them: the full weight of Accor — the world's largest hotel group — behind every square meter, an address that will define a generation of Cancún real estate, unobstructed views of both the Caribbean Sea and Laguna de Nichupté that no future construction will ever block, and a pre-sale price that still makes sense before it no longer does.</p>
      ...
      <div className="my-10 text-center">
        <Link to={localePath('/propiedad/mondrian-residences-grand-island-cancun')}>
          <Button variant="gold" size="lg">View the Mondrian Residences property →</Button>
        </Link>
      </div>
      ...
      <p>One of the dimensions that most distinguishes Mondrian Residences from the rest of Cancún's pre-sale offering is the amenity ecosystem available to residents — not only those within the building itself, but those of the entire Grand Island complex, operated to Accor's standards.</p>
      ...
      <p>If you'd like to explore unit availability, review contract details, or understand whether Mondrian Residences aligns with your investment goals and lifestyle vision, the first step is a conversation.</p>
      ...
      <div className="my-12 text-center">
        <a href="https://wa.me/529988457224?text=I%20Want%20Real%20Estate%20Advisory%20about%20Mondrian%20Residences" target="_blank" rel="noopener noreferrer" className="block">
          <Button variant="gold" size="lg" className="w-full max-w-lg mx-auto">I Want Real Estate Advisory about Mondrian Residences</Button>
        </a>
      </div>
