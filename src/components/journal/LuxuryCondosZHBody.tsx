...
export const LuxuryCondosZHBodyES = () => (
  <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
    ...
    <h3 className="text-foreground font-display text-2xl mt-8 mb-3">Mondrian Residences at Grand Island Cancun</h3>
    <p>
    ...
    <div className="bg-card border border-border rounded-sm p-6 my-8 space-y-4">
      <p><strong className="text-foreground">Flujo de caja inmediato sin gestión:</strong> Mondrian Residences at Grand Island Cancun. La gestión Marca Elite internacional opera por ti desde el primer día.</p>
...
export const LuxuryCondosZHBodyEN = () => (
  <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
    ...
    <div className="bg-card border border-border rounded-sm p-6 my-8 space-y-4">
      <p><strong className="text-foreground">Immediate cash flow without management:</strong> Mondrian Residences at Grand Island Cancun. Marca Elite internacional manages from day one. You receive the returns.</p>
