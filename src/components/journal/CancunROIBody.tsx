      ...
      <div className="bg-card border border-border rounded-sm p-8 text-center my-12">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Button variant="gold" asChild>
            <a href="https://wa.me/529988457224?text=Quiero%20asesor%C3%ADa%20inmobiliaria&utm_source=web&utm_medium=whatsapp&utm_campaign=lead&utm_content=journal-cancun-roi-es" target="_blank" rel="noopener noreferrer">Recibir más información</a>
          </Button>
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <div className="bg-card border border-border rounded-sm p-8 text-center my-12">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Button variant="gold" asChild>
            <a href="https://wa.me/529988457224?text=I%20want%20real%20estate%20advisory&utm_source=web&utm_medium=whatsapp&utm_campaign=lead&utm_content=journal-cancun-roi-en" target="_blank" rel="noopener noreferrer">Get More Info</a>
          </Button>
          <Button variant="gold-outline" asChild>
