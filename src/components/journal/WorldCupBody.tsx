...
export const WorldCupBodyES = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <PropertyCard name="Mondrian Residences at Grand Island Cancun" badge="Preventa · ROI 33%" detail="Gestión Marca Elite internacional · Llave en mano · Desde $9,050,000 MXN · Entrega Q2 2027" link={localePath('/propiedad/mondrian-residences-grand-island-cancun')} />
      ...
      <div className="bg-card border border-border rounded-sm p-8 my-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a href="https://wa.me/529988457224?text=Quiero%20asesor%C3%ADa%20inmobiliaria&utm_source=web&utm_medium=whatsapp&utm_campaign=lead&utm_content=journal-worldcup-es" target="_blank" rel="noopener noreferrer">
            <Button variant="gold" size="lg">Recibir más información</Button>
          </a>
...
export const WorldCupBodyEN = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <PropertyCard name="Mondrian Residences at Grand Island Cancun" badge="Pre-Sale · ROI 33%" detail="Marca Elite internacional management · Turnkey · From $9,050,000 MXN · Q2 2027 delivery" link={localePath('/propiedad/mondrian-residences-grand-island-cancun')} />
      ...
      <div className="bg-card border border-border rounded-sm p-8 my-12 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a href="https://wa.me/529988457224?text=I%20want%20real%20estate%20advisory&utm_source=web&utm_medium=whatsapp&utm_campaign=lead&utm_content=journal-worldcup-en" target="_blank" rel="noopener noreferrer">
            <Button variant="gold" size="lg">Get More Info</Button>
          </a>
          <Link to={localePath('/listings')}>
