...
export const WorldCupBodyES = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <PropertyCard name="The Residences at Grand Island Cancun" badge="Preventa · ROI 33%" detail="Gestión Accor · Llave en mano · Desde $9,050,000 MXN · Entrega Q2 2027" link={localePath('/propiedad/mondrian-residences-grand-island-cancun')} />
...
export const WorldCupBodyEN = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <PropertyCard name="The Residences at Grand Island Cancun" badge="Pre-Sale · ROI 33%" detail="Accor management · Turnkey · From $9,050,000 MXN · Q2 2027 delivery" link={localePath('/propiedad/mondrian-residences-grand-island-cancun')} />
