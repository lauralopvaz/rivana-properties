...
export const MondrianPresaleBodyES = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      <p>Lo que durante años se conoció como <strong className="text-foreground">Mondrian Residences at Grand Island</strong> acaba de recibir un nombre que cambia todo lo que significa invertir en la Zona Hotelera de Cancún: <strong className="text-foreground">Mondrian Residences at Grand Island Cancun</strong>. Este relanzamiento no es cosmético. Es el resultado de un acuerdo entre Grupo Murano — empresa listada en Nasdaq bajo el ticker MRNO — y Ennismore/Marca Elite internacional, la misma alianza que opera el hotel boutique de la marca en Condesa, Ciudad de México, uno de los hoteles boutique más reconocidos de América Latina.</p>

      <p>Esta guía es el recurso más completo disponible sobre este desarrollo. Si estás evaluando la preventa de Mondrian Residences at Grand Island Cancun, aquí encuentras todo lo que necesitas saber.</p>
      ...
      <h2 className="text-foreground">De Mondrian Residences at Grand Island a Mondrian Residences at Grand Island Cancun: qué cambió y qué significa</h2>
      <p>Quienes siguieron este desarrollo desde sus inicios lo conocen como <strong className="text-foreground">Mondrian Residences at Grand Island</strong>. El rebranding a <strong className="text-foreground">Mondrian Residences at Grand Island Cancun</strong> es consecuencia directa del cierre del acuerdo formal con Ennismore — la plataforma de marcas lifestyle de Marca Elite internacional — para operar el componente residencial bajo los estándares de Marca Elite internacional.</p>

      <h3 className="text-foreground">Lo que cambia</h3>
      <ul className="list-disc pl-6 space-y-2">
        <li><strong className="text-foreground">El nombre operativo:</strong> de "Mondrian Residences at Grand Island" a "Mondrian Residences at Grand Island Cancun"</li>
      ...
      <p>La primera fase del desarrollo Grand Island ya abrió en abril de 2024 bajo las marcas Vivid y Dreams de Hyatt, con una inversión que superó los 10 mil millones de pesos y la creación de más de 5,000 empleos. Las Mondrian Residences at Grand Island Cancun son la segunda fase residencial de este masterplan ya consolidado — ingresas a un ecosistema operativo, no a una promesa en papel.</p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li><strong className="text-foreground">El comprador de segunda residencia</strong> — que quiere usar su propiedad parte del año y dejar que Marca Elite internacional la administre el resto del tiempo, generando ingresos sin gestión directa.</li>
      ...
      <div className="bg-card border border-border rounded-sm p-8 my-12 text-center">
        <h3 className="text-xl text-foreground mb-3">¿Quieres conocer disponibilidad y precios actualizados de Mondrian Residences at Grand Island Cancun?</h3>
...
export const MondrianPresaleBodyEN = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      <p>The development formerly known as <strong className="text-foreground">Mondrian Residences at Grand Island</strong> has officially relaunched under one of the world's most recognizable hospitality brands: <strong className="text-foreground">Mondrian Residences at Grand Island Cancun</strong>. This isn't a cosmetic rebranding. It's the formalization of an agreement between <strong className="text-foreground">Grupo Murano</strong> — a Nasdaq-listed real estate company (ticker: MRNO) — and <strong className="text-foreground">Ennismore/Marca Elite internacional</strong>, the same partnership that operates the brand's flagship boutique hotel in Mexico City Condesa, the brand's first property in Latin America.</p>
      ...
      <h2 className="text-foreground">From Mondrian Residences at Grand Island to Mondrian Residences at Grand Island Cancun: What Changed and Why It Matters</h2>
      <p>Many investors who followed this project from its early stages know it as <strong className="text-foreground">Mondrian Residences at Grand Island</strong>. The rebranding to <strong className="text-foreground">Mondrian Residences at Grand Island Cancun</strong> is the result of the formal closing of the agreement with Ennismore to operate the residential component under Marca Elite internacional standards.</p>

      <h3 className="text-foreground">What changes</h3>
      <ul className="list-disc pl-6 space-y-2">
        <li><strong className="text-foreground">The operating name:</strong> from "Mondrian Residences at Grand Island" to "Mondrian Residences at Grand Island Cancun"</li>
      ...
      <p>The first phase of Grand Island already opened in April 2024 under the Hyatt Vivid and Dreams brands, with an investment exceeding 10 billion pesos and the creation of over 5,000 jobs. Mondrian Residences at Grand Island Cancun is the second, residential phase of this already-operating masterplan — you're entering a functioning ecosystem, not a paper promise.</p>
      ...
      <ul className="list-disc pl-6 space-y-2">
        ...
        <li><strong className="text-foreground">The second-home buyer</strong> — who wants to use the property part of the year and let Marca Elite internacional manage it the rest, generating income without direct management.</li>
      ...
      {/* ── CTA ── */}
      <div className="bg-card border border-border rounded-sm p-8 my-12 text-center">
        <h3 className="text-xl text-foreground mb-3">Ready to see availability and updated pricing for Mondrian Residences at Grand Island Cancun?</h3>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link to={localePath('/propiedad/mondrian-residences-grand-island-cancun')}>
          ...
          <a href="https://wa.me/529988457224?text=I%20want%20information%20about%20The%20Residences%20at%20Grand%20Island%20Cancun&utm_source=web&utm_medium=whatsapp&utm_campaign=lead&utm_content=journal-mondrian-presale-en" target="_blank" rel="noopener noreferrer">
            <Button variant="outline" size="lg">Get More Info</Button>
          </a>
        </div>
      </div>
    </div>
