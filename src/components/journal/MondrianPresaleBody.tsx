...
export const MondrianPresaleBodyES = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <p>La primera fase del desarrollo Grand Island ya abrió en abril de 2024 bajo las marcas Vivid y Dreams de Hyatt, con una inversión que superó los 10 mil millones de pesos y la creación de más de 5,000 empleos. Las The Residences at Grand Island Cancun son la segunda fase residencial de este masterplan ya consolidado — ingresas a un ecosistema operativo, no a una promesa en papel.</p>
      ...
      <div className="bg-card border border-border rounded-sm p-8 my-12 text-center">
        <h3 className="text-xl text-foreground mb-3">¿Quieres conocer disponibilidad y precios actualizados de The Residences at Grand Island Cancun?</h3>
...
export const MondrianPresaleBodyEN = () => {
  ...
  return (
    <div className="text-muted-foreground font-body text-[17px] leading-[1.8] space-y-6">
      ...
      <p>The project offers units ranging from <strong className="text-foreground">1 to 3 bedrooms plus loft</strong>, with surfaces between 829 and 1,773 sq ft, designed by <strong className="text-foreground">Filipao Nunes Arquitectos</strong> — the Portuguese firm behind the Mondrian properties in Dubai and Doha — and operated under the Mondrian brand by Marca Elite internacional, with delivery scheduled for <strong className="text-foreground">Q2 2027</strong>.</p>
      ...
      {/* ── CTA ── */}
      <div className="bg-card border border-border rounded-sm p-8 my-12 text-center">
        <h3 className="text-xl text-foreground mb-3">Ready to see availability and updated pricing for The Residences at Grand Island Cancun?</h3>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link to={localePath('/propiedad/mondrian-residences-grand-island-cancun')}>
