...
const PreSale = () => {
  ...
  const submitBrochure = async () => {
    ...
    const msg = encodeURIComponent(
      '📋 *Nueva solicitud de brochure — Mondrian Residences*\n\n' +
      '👤 Nombre: ' + brForm.name + '\n' +
  ...
  const faqs = L === 'es' ? [
    { q: '¿Cuánto cuesta un departamento en Mondrian Residences Cancún?', a: 'El precio de preventa parte desde $514,000 USD para unidades de 76.96 m² hasta 164.75 m² con loft. En pesos equivale a desde $9,050,000 MXN, con un ahorro de $2,950,000 MXN frente al precio de lista de $12,000,000 MXN. A partir del 1 de junio de 2026, el precio aumenta 33%.' },
    ...
    { q: 'How much does a unit at Mondrian Residences Cancún cost?', a: 'Pre-sale pricing starts at $514,000 USD for units from 76.96 m² up to 164.75 m² lofts. In MXN that\'s from $9,050,000, saving $2,950,000 MXN vs. the list price of $12,000,000 MXN. After June 1, 2026, prices increase by 33%.' },
    ...
    <>
      <SEOHead
        ...
        schema={{
          ...
          name: "Mondrian Residences at Grand Island Cancún — Preventa",
      ...
      <section className="ps-hero">
        ...
        <div className="ps-hero-content">
          ...
          <h1>Mondrian Residences<br /><em>at Grand Island</em></h1>
      ...
      <div className="ps-gallery">
        <div className="ps-gal-img">
          <img src={mondrianHero} alt="Mondrian Residences at Grand Island — Vista exterior Zona Hotelera Cancún" />
        </div>
        <div className="ps-gal-img">
          <img src={mondrianFrontDesk} alt="Mondrian Residences — Lobby diseño Filipao Nunes Arquitectos" />
        </div>
        <div className="ps-gal-img">
          <img src={mondrianCoffeeBar} alt="Mondrian Residences Cancún — Coffee bar amenidades premium Accor" />
        </div>
      </div>
      ...
      <section className="ps-sec">
        ...
        <p className="ps-body-t">
          {L === 'es'
            ? <>El precio de preventa de <strong>$514,000 USD</strong> representa el precio de lanzamiento acordado con el desarrollador para los primeros inversionistas de Mondrian Residences at Grand Island Cancún. A partir del 1 de junio de 2026, el precio aumenta 33%, llevando el valor de entrada a aproximadamente <strong>$683,000 USD</strong>.</>
            : <>The pre-sale price of <strong>$514,000 USD</strong> is the launch price agreed with the developer for early investors in Mondrian Residences at Grand Island Cancún. After June 1, 2026, the price increases by 33%, bringing the entry value to approximately <strong>$683,000 USD</strong>.</>}
        </p>
        <p className="ps-body-t">
          {L === 'es'
      ...
      <section className="ps-plan-sec">
        ...
        <h2>{L === 'es' ? <>Plan de pago<br /><em>Mondrian Residences</em></> : <>Payment plan<br /><em>Mondrian Residences</em></>}</h2>
      ...
      <div className="ps-link-ficha">
        ...
        <a href={localePath('/propiedad/mondrian-residences-grand-island-cancun')}>
          {L === 'es' ? 'Ver ficha completa de Mondrian Residences →' : 'View full Mondrian Residences listing →'}
        </a>
      </div>
          ...
          <div className="ps-modal-box">
            ...
            {!modalSuccess ? (
              <>
                ...
                <h3>Mondrian Residences<br />— {L === 'es' ? 'Planos & Precios' : 'Plans & Pricing'}</h3>
