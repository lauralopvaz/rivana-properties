...
const t = {
  es: {
    ...
    faqs: [
      { q: '¿Dónde se ubica Mondrian Residences at Grand Island Cancún?', a: 'En Boulevard Kukulcán km 16.5, dentro del desarrollo maestro Grand Island, en la Zona Hotelera de Cancún. Es el único proyecto con vistas simultáneas a la Laguna Nichupté, el Mar Caribe y el campo de golf.' },
      { q: '¿Cuál es el precio de preventa?', a: 'La preventa inicia desde $514,000 USD (aproximadamente $9,050,000 MXN). El precio aumenta conforme avanza la comercialización y al alcanzar hitos de obra.' },
      { q: '¿Cuándo es la entrega?', a: 'La entrega está proyectada para el segundo trimestre de 2027 (Q2 2027). Cada unidad se entrega llave en mano: totalmente amueblada y equipada.' },
      { q: '¿Cuál es el plan de pagos?', a: 'Plan flexible 30 / 20 / 50: 30% de enganche a la firma, 20% diferido en 12 meses sin intereses y 50% restante a la entrega.' },
      { q: '¿Qué tipos de unidades hay disponibles?', a: 'Residencias de 1, 2 y 3 recámaras, además de lofts, con superficies de 76.96 a 164.75 m². Todas con terraza y vistas panorámicas.' },
      { q: '¿Qué amenidades incluye?', a: 'Rooftop infinity pool, club lounge y restaurante en azotea, spa & wellness, gimnasio firma, marina privada, acceso a campo de golf de 18 hoyos, beach club, concierge 24/7, coworking, kids club y pet garden.' },
      { q: '¿Quién diseña y opera el desarrollo?', a: 'Diseño arquitectónico de Filipao Nunes Arquitectos y operación bajo una marca élite hotelera internacional, lo que garantiza ocupación premium para renta vacacional.' },
      { q: '¿Puede generar renta como inversión?', a: 'Sí. Al entregarse llave en mano y bajo operación de marca hotelera internacional, la unidad puede integrarse al programa de rentas desde el primer día, sin gestión directa del propietario.' },
    ],
    ctaEnd: {
  ...
  en: {
    ...
    faqs: [
      { q: 'Where is Mondrian Residences at Grand Island Cancún located?', a: 'At Boulevard Kukulcán km 16.5, inside the Grand Island master development in Cancún\'s Hotel Zone. It is the only project with simultaneous views over Nichupté Lagoon, the Caribbean Sea, and the golf course.' },
      { q: 'What is the pre-sale price?', a: 'Pre-sale starts at $514,000 USD (approximately $9,050,000 MXN). Prices step up as marketing progresses and construction milestones are reached.' },
      { q: 'When will units be delivered?', a: 'Delivery is scheduled for the second quarter of 2027 (Q2 2027). Every residence is delivered turnkey: fully furnished and equipped.' },
      { q: 'What is the payment plan?', a: 'A flexible 30 / 20 / 50 plan: 30% down at signing, 20% deferred over 12 months with no interest, and the remaining 50% at delivery.' },
      { q: 'What unit types are available?', a: '1, 2, and 3-bedroom residences plus lofts, ranging from 76.96 to 164.75 sqm. All units include a terrace and panoramic views.' },
      { q: 'What amenities are included?', a: 'Rooftop infinity pool, rooftop club lounge and restaurant, spa & wellness, signature gym, private marina, access to an 18-hole golf course, beach club, 24/7 concierge, coworking, kids club, and pet garden.' },
      { q: 'Who designs and operates the development?', a: 'Architectural design by Filipao Nunes Arquitectos, with hospitality operations under an elite international hotel brand — ensuring premium occupancy for vacation rental.' },
      { q: 'Can it generate rental income?', a: 'Yes. Because units are delivered turnkey and run by an international hotel operator, your residence can join the rental program from day one — no direct management required.' },
    ],
    ctaEnd: {
