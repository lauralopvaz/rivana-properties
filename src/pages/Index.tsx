        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10 text-center text-[hsl(var(--pearl))] home-hero-content flex flex-col justify-center items-center" style={{ paddingTop: '80px' }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up home-hero-buttons" style={{ animationDelay: '0.8s', marginTop: '36px' }}>
            <Button variant="gold" size="lg" className="rounded-none text-[hsl(var(--deep-black))]" asChild>
              <a
                href={language === 'es'
                  ? 'https://wa.me/529988457224?text=HOME%20HERO%20%E2%80%94%20Quiero%20iniciar%20mi%20asesor%C3%ADa%20inmobiliaria&utm_source=webhttps://wa.me/529988457224?text=HOME%20HERO%20%E2%80%94%20Quiero%20iniciar%20mi%20asesor%C3%ADa%20inmobiliariautm_medium=whatsapphttps://wa.me/529988457224?text=HOME%20HERO%20%E2%80%94%20Quiero%20iniciar%20mi%20asesor%C3%ADa%20inmobiliariautm_campaign=lead&utm_content=home-hero-es'
                  : 'https://wa.me/529988457224?text=HOME%20HERO%20EN%20-%20I%20want%20to%20start%20my%20real%20estate%20advisory&utm_source=webhttps://wa.me/529988457224?text=HOME%20HERO%20EN%20-%20I%20want%20to%20start%20my%20real%20estate%20advisoryutm_medium=whatsapphttps://wa.me/529988457224?text=HOME%20HERO%20EN%20-%20I%20want%20to%20start%20my%20real%20estate%20advisoryutm_campaign=lead&utm_content=home-hero-en'}
                target="_blank"
