...
const units: Unit[] = [
  ...
  },
  {
    ...
    priceMXN: 12000000,
    priceLabel: { es: "Antes $13.2M MXN", en: "Was $13.2M MXN" },
    status: { es: "Amueblada — reducción de $1.2M", en: "Furnished — $1.2M reduction" },
    furnished: true,
    ...
    highlights: {
      es: [
        ...
        "Cocina integrada de alta gama con paquete completo",
        "Área de lavandería privada y bodega",
        "Reducción excepcional: de $13.2M a $12M MXN",
      ],
      en: [
        ...
        "High-end integrated kitchen with full appliance package",
        "Private laundry area and storage room",
        "Exceptional price reduction: from $13.2M to $12M MXN",
      ],
    },
    description: {
