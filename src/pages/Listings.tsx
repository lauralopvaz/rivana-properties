...
const allProperties: Property[] = [
  { id: 3, name: 'Mondrian Residences at Grand Island Cancun', zone: 'Zona Hotelera', type: 'condominio', beds: 3, area: 165, price: 514000, priceM2: 3115, status: 'preventa', yield: '33%', badges: ['vista-mar', 'club-privado', 'beach-club', 'wellness'], image: propMondrian, slug: 'mondrian-residences-grand-island-cancun' },
  ...
  return (
    <div style={{ background: '#F8F6F2' }}>
      ...
      <section className="pt-28 pb-8 px-6 lg:px-10 max-w-[1400px] mx-auto">
        ...
        <h1 className="font-display text-[clamp(40px,5vw,52px)] font-normal mb-3" style={{ color: '#1C1C1C' }}>{L === 'es' ? 'Propiedades en Venta' : 'Properties for Sale'}</h1>
        <p className="font-body font-normal text-[16px] max-w-xl" style={{ color: '#4B4B4B', lineHeight: 1.8 }}>{L === 'es' ? 'Explora nuestra colección seleccionada de propiedades de lujo en Cancún y la Riviera Maya.' : 'Explore our curated collection of luxury properties in Cancún and the Riviera Maya.'}</p>
      </section>
