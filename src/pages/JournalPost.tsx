  ...
  const retireCanadianFaqSchema = {
    ...
    mainEntity: language === 'en'
      ? [
          ...
          { '@type': 'Question', name: 'Is it better to buy now or wait?', acceptedAnswer: { '@type': 'Answer', text: 'Quintana Roo led national appreciation in 2026 (+14.3%, SHF), there are ~22,000 new units in the state pipeline for 2026–2026, and Banxico lowered its rate to 7% in December 2026. The right decision depends on horizon, liquidity and the specific zone.' } },
        ]
      : [
          ...
          { '@type': 'Question', name: '¿Conviene comprar ahora o esperar?', acceptedAnswer: { '@type': 'Answer', text: 'Quintana Roo lideró la apreciación nacional en 2026 (+14.3%, SHF), hay ~22,000 unidades nuevas en el pipeline estatal 2026-2026, y Banxico bajó su tasa a 7% en diciembre de 2026. La decisión correcta depende de horizonte, liquidez y zona.' } },
        ],
  };
      ...
      <section className="py-16 px-6 max-w-[1100px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <article className="lg:col-span-3 space-y-8">
            ...
            ) : articleSlug === 'preventa-puerto-cancun' ? (
              <PreventaPuertoCancunBody />
            ) : articleSlug === 'departamentos-en-venta-costa-mujeres' ? (
            ...
            ) : articleSlug === 'pre-construction-condos-cancun' ? (
