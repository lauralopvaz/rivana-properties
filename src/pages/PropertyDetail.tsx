        ...
        <div className="grid items-start grid-cols-1 lg:grid-cols-[62%_38%]">
          ...
          <div className="pt-8 lg:pt-14 pl-0 lg:pl-4">
            <aside className="sticky top-6 bg-white border border-[rgba(207,174,96,0.24)] shadow-[0_6px_48px_rgba(0,0,0,0.07)] p-6">
              ...
              <a
                href="https://wa.me/529988457224?text=Quiero%20asesor%C3%ADa%20inmobiliaria&utm_source=webQuiero%20asesor%C3%ADa%20inmobiliaria"utm_medium=whatsappQuiero%20asesor%C3%ADa%20inmobiliaria"utm_campaign=lead&utm_content=property-detail-hero"
                target="_blank"
              ...
              <div className="border-t border-[rgba(207,174,96,0.18)] pt-4">
                ...
                {!unitFormOpen ? (
                  <div className="space-y-2.5">
                    ...
                    <a
                      href="https://wa.me/529988457224?text=Quiero%20asesor%C3%ADa%20inmobiliaria&utm_source=webQuiero%20asesor%C3%ADa%20inmobiliaria"utm_medium=whatsappQuiero%20asesor%C3%ADa%20inmobiliaria"utm_campaign=lead&utm_content=property-detail-body"
                      target="_blank"
                      rel="noopener noreferrer"
