...
const projectsByDestination: Record<string, DestProject[]> = {
  'zona-hotelera': [
    { name: 'Mondrian Residences at Grand Island Cancun', zone: 'Zona Hotelera', status: 'preventa', yield: '33%', beds: 3, area: 165, price: 514000, badges: ['vista-mar', 'club-privado', 'beach-club', 'wellness'], image: propMondrian, slug: 'mondrian-residences-grand-island-cancun' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              {isZHEn ? (
                <div className="space-y-4 text-muted-foreground font-body text-base leading-relaxed">
                  ...
                  <p>The bridge is the single most significant infrastructure event in the Hotel Zone in two decades. Properties south of Km 12 — including Mondrian Residences at Grand Island Cancun and Bay View Grand at Grand Island — sit directly in the appreciation corridor it has created.</p>
                  ...
                  <p>Pre-sale appreciation — the difference between the price paid at contract and the appraised value at delivery — has run at 15% to 33% across Hotel Zone developments delivered in recent years. Mondrian Residences at Grand Island Cancun, Rivana's flagship listing in the zone, projects 33% appreciation between pre-sale entry and Q2 2027 delivery.</p>
            ...
            <ScrollReveal>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-4 text-muted-foreground font-body text-base leading-relaxed">
                  ...
                  <p>For buyers considering Mondrian Residences at Grand Island Cancun or Bay View Grand at Grand Island — both located in the Punta Nizuc zone — the timing is meaningful. Pre-sale pricing reflects the pre-bridge reality. Delivery pricing will reflect the new one.</p>
                </div>
              </div>
            </ScrollReveal>
          </div>
