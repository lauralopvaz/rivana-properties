      ...
      <section className="py-20 px-6 lg:px-10 max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { icon: <EyeIcon className="w-6 h-6" />, title: language === 'es' ? 'Acceso Seleccionado' : 'Curated Access', desc: language === 'es' ? 'Decimos no al 80% de las propiedades que evaluamos. Solo las mejores llegan a nuestra colección.' : 'We say no to 80% of properties we evaluate. Only the best make it into our collection.' },
